...
$roompic=md5($pgpic).$extension;
    ...
    $query=mysqli_query($con, "insert into tblpg(OwnerID,StateName, CityName, PGTitle, Type, RPmonth,gst,st,tpa,norooms,Address,Electricity,Parking,Refregerator,Furnished,AC,Balcony,StudyTable,Laundry,Security,Fullname,Email,MobileNumber,Image) value('$ownerid','$statename','$cityname','$pgname','$Type','$rpmonth',$gst,$st,$tpa,'$norooms','$address','$electricity','$parking','$ref','$furnished','$ac','$balcony','$table','$laundry','$security','$fName','$mail','$contact','$roompic')");
    if ($query) {
...
<div class="col-sm-6">
<input type="radio" name="Type" id="Type" value="Boys" checked="true">
 Boys
<input type="radio" name="Type" id="Type" value="Girls">
Girls
<input type="radio" name="Type" id="Type" value="Both">
Both
</div>
                            </div>
                    <div class="form-group">
...
$ret=mysqli_query($con,"select * from  tblowner where ID='$pownerid'");
...
?>
                    <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">Owner Name</label>
                        <div class="col-lg-6">
                            <label class="checkbox-inline">
                                <input type="text" id="fullname" name="fullname" value="<?php echo $name?>" required="true">
                            </label>
                          </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">Owner Email</label>
                        <div class="col-lg-6">
                            <label class="checkbox-inline">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">Owner Contact</label>
                        <div class="col-lg-6">
                            <label class="checkbox-inline">
                                <input type="text" id="phone" name="phone" value="<?php echo $phone?>" required="true">
                            </label>
                          </div>
                    </div>
