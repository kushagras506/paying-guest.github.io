          ...
          <tr data-expanded="true">
            <td><?php echo $cnt;?></td>
              <td><?php  echo $row['FullName'];?></td>
                  ...
                  <td><a class="btn btn-info" href="view-requestdetails.php?viewid=<?php echo $row['ID'];?>">View Details</a>
                  <a class="btn btn-danger ml-2" href="delete-requestdetails.php?deleteid=<?php echo $row['ID'];?>">Delete</a>
</td>
                </tr>
                <?php 
$cnt=$cnt+1;
