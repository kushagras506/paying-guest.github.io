...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update tblpg set StateName='$statename', CityName='$cityname', PGTitle='$pgname', Type='$Type', RPmonth='$rpmonth',norooms='$norooms',Address='$address',Electricity='$electricity',Parking='$parking',Refregerator='$ref',Furnished='$furnished',AC='$ac',Balcony='$balcony',StudyTable='$table',Laundry='$laundry',Security='$security',Fullname='$fName',Email='$mail',MobileNumber='$contact' where ID='$eid'");
    if ($query) {
...
?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <label class="checkbox-inline">
                                <input type="text" id="email" name="email" value="<?php echo $email?>" required="true">
                            </label>
                          </div>
                    </div>
                    <div class="form-group">
