        ...
        <div class="container">
            <div class="row d-flex text-center align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <h1 class="text-white"><?php echo $pid?></h1>
    ...
    <section class="blog_area single-post-area p_120">
        <div class="container">
            <div class="row mt-80">
                 <?php
 $cid=$_GET['pid'];
$ret=mysqli_query($con,"select * from tblpg  where tblpg.ID=$cid");
$cnt=1;
...
<h2 align="center" style="margin-top:2%"><?php echo $row['PGTitle'];?>'s Details</h2>      
  ...
  <tr>
    ...
    <td><?php  echo $row['RPmonth'];?> INR</td>
  </tr>  
   <tr>
...
<tr>
  ...
  <table border="1" class="table table-bordered mg-b-0">
<tr align="center">
<td style="color: red; font-size: 20px" colspan="2">Owner details</td>
</tr> 
  <tr>
    <th>Fullname</th>
...
<div class="form-group">
              ...
              <p style="font-size: 18px;color: black">Check In Date: <input type="date" class="form-control" id="chkin" name="chkin" required="true" onchange="changechkout()"></p>

              <script>
								var today=new Date().toISOString().split('T')[0];
								document.getElementById("chkin").min=today;
								function changechkout(){
								var temp=new Date(document.getElementById("chkin").value);
								temp.setMonth(temp.getMonth()+1);
								document.getElementById("chkout").value=temp.toISOString().split('T')[0];
								}
							</script>
              ...
              <div class="form-group">
              <p style="font-size: 18px;color: black">Check Out Date: <input type="date" class="form-control" id="chkout" name="chkout" required="true"readonly></p>
              </div>
